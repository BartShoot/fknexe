...
export const testCases = [
  {
    ...
    cases: [
      ...
      },
      {
        ...
        names: ripgrepNames,
        expectedMatches: {
          'ripgrep-14.1.1-x86_64-pc-windows-gnu.zip': ['OS', 'Architecture', 'Extension'],
          'ripgrep-14.1.1-x86_64-pc-windows-msvc.zip': ['OS', 'Architecture', 'Extension'],
          'ripgrep-14.1.1-i686-pc-windows-msvc.zip': ['OS', 'Extension'],
          'ripgrep-14.1.1-aarch64-apple-darwin.tar.gz': [],
          'ripgrep-14.1.1-aarch64-unknown-linux-gnu.tar.gz': [],
          'ripgrep-14.1.1-armv7-unknown-linux-gnueabihf.tar.gz': [],
          'ripgrep-14.1.1-armv7-unknown-linux-musleabi.tar.gz': [],
